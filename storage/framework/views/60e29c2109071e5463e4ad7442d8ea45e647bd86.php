...
<head>
  <!-- Title -->
  <title>Research - Yielda Capital</title>
...
<body>
  ...
  <section class="wwd-section">
    <div class="container">
      ...
      <hr>
        <h4>Our research division provides original,
          fundamental insights and analysis for clients in the equity,
          fixed income, currency and commodities markets.</h4>
      </div>
    </div>
  </section>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="<?php echo e(asset('img/pages-images/research-services.jpeg')); ?>" />
        </div>
        <div class="col">
          <div class="wwd-subsection-content">
              <p>Our research reports, which cover topics such as economics, portfolio strategy, derivatives, and equity
                and credit securities,
                assist investors in better understanding the issues and trends affecting companies, industries, and
                markets. </p>
                <p>We have teams committed to a broad variety of industries, economies, and issues.</p>
              <hr>
                <p><b>Equity Research</b> has business and company divisions that study financial markets all over the world
                to find investing opportunities.</p>
              <hr>
                <p><b>Macro Research</b> analysts analyze a wide range of securities, markets and economies.
                Economic Research analysts provide macroeconomic, foreign exchange rate and interest rate forecasts.
                Strategy Research analysts provide market views,
                forecasts and recommendations covering areas such as asset allocation and investment strategies,
                and Commodities Research analysts forecast commodity prices.</p>
              <hr>
                <p><b>Credit Research</b> evaluate corporate debt to cover various business markets in order to recognize and convey investment prospects. </p>
            </div>
          </div>
        </div>
      </div>
...
</html><?php /**PATH C:\xampp\htdocs\deftTechnologies\resources\views//research/services.blade.php ENDPATH**/ ?>