...
<head>
  <!-- Title -->
  <title>ML & AI Deft Technologies Limited</title>
  ...
  <section class="wwd-section">
    <div class="container">
      ...
      <div class="wwd-content">
        <hr>
        <h4>Business intelligence comprises the strategies and technologies
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="<?php echo e(asset('img/pages-images/BusinessIntelligence.jpg')); ?>" />
      </div>
      <div class="col">
...
</html><?php /**PATH C:\xampp\htdocs\deftTechnologies\resources\views//advisory-firms/asset-management.blade.php ENDPATH**/ ?>