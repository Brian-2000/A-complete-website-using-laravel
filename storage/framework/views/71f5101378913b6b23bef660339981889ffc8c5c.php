...
<head>
  <!-- Title -->
  <title>Location - Yielda Capital</title>
...
<body>
  ...
  <section class="section-1-section">
    <div class="container">
      <div class="section-1-title-section">
        ...
        <hr>
        <h6>Yielda is a true nation citizen, with offices and employees 
            around the world. As technology links us closer together and regulatory 
            barriers are broken down, the firm is in a unique position to address 
            the increasingly global needs of our clients.</h6>
      </div>
    </div>
  </section>
  ...
  <section class="section-1-subsection-1">
    <div class="container">
      <div class="row">
        <div class="col">
          <img src="<?php echo e(asset('img/pages-images/location.jpeg')); ?>"/>
        </div>
        <div class="col">
          <div class="section-1-subsection-1-content">
            <h4>Nairobi, Kenya</h4>
            <h6>In 1994, Yielda was the first global investment bank to open an office in 
                Kenya after the lifting of sanctions. Since then, Yielda has advised 
                clients on mergers, acquisitions, restructurings, equity and debt capital raisings 
                and black economic empowerment transactions, spanning all major sectors of the Kenyan economy. The Kenya country specialists, based in Nairobi, 
                have full access to Yielda's global network of industry, product and other 
                experts. Kenyan activities include providing commodity, foreign exchange, 
                asset liability management and interest-rate-related solutions to local clients as 
                well as actively participating in the domestic bond, equity and derivative markets.</h6>
              <hr>
              <h6>In 2005, Yielda announced its joint venture, 
                    the leading domestic merchant bank, to provide sales and trading services for
                    equity-linked securities, publish research on Kenyan companies 
                    and distribute Yielda's global equity research in Kenya.</h6>
              <hr>
              <h6>In September 2006, Yielda entered into a debt cooperation agreement. 
                  The debt cooperation agreement allows Yielda to leverage 
                  jointly their respective skill sets and provide differentiated debt capital market 
                  and related solutions for our Kenyan clients. Products include global investment 
                  and non-investment grade bonds and securitisation offerings of local assets for 
                  Kenyan corporate clients.</h6>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="js-scrollbar u-sidebar__body">
            <div class="u-sidebar__content py-5">
              ...
              <ul class="list-unstyled font-size-14 mb-5">
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="<?php echo e(asset('/components/projects-dark-icon.svg')); ?>" alt="Image Description">
                    <div class="media-body">
                      <span>Projects</span>
                    </div>
                  </a>
...
</html><?php /**PATH C:\xampp\htdocs\deftTechnologies\resources\views//our-firm/location.blade.php ENDPATH**/ ?>