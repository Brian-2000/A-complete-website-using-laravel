...
<head>
  <!-- Title -->
  <title>Cross-platform- Deft Technologies Limited</title>
  ...
  <section class="wwd-section">
    <div class="container">
      <div class="wwd-title">
        ...
        <h4>We develope more efficient mobile Applications that can 
          be used on both Android mobile phones and iOS 
        </h4>
      </div>
    </div>
  </section>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="<?php echo e(asset('img/pages-images/cross.png')); ?>" />
      </div>
      <div class="col">
...
</html><?php /**PATH C:\xampp\htdocs\deftTechnologies\resources\views//institutional-investors/securities-services.blade.php ENDPATH**/ ?>