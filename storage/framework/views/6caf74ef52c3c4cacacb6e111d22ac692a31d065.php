...
<head>
  <!-- Title -->
  <title>Network Security-Deft Technologies Limited</title>
  ...
  <section class="wwd-section">
    <div class="container">
      <div class="wwd-title">
        ...
        <hr>
        <h4>Network Security is a Very Crucial activity in any IT firm, any business or any Individual
          As Deft Technologies Limited, we assure security in totality.
        </h4>
      </div>
    </div>
  </section>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="<?php echo e(asset('img/pages-images/network.png')); ?>" />
      </div>
      <div class="col ">
        <div class="wwd-subsection-content">
            <h1 style="color: forestgreen;">Deft</h1>
            <h1 style="color: forestgreen;">Technologies</h1>
            <h1 style="color: forestgreen;">Limited</h1>
        </div>
      </div>
      </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\deftTechnologies\resources\views//treasury-payments/receivables.blade.php ENDPATH**/ ?>