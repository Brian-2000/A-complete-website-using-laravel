...
<head>
  <!-- Title -->
  <title>Android- Deft Technologies Limited</title>
    ...
    <div class="container">
      <div class="wwd-title">
        ...
        <h4>At Deft Technologies Limited, we develop and deliver high class Android
            ...
            <br>
            At Deft Technologies Limited We got you covered.
        </h4>
      </div>
    </div>
  </section>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="{{ asset('img/pages-images/android-app-development.png') }}" />
      </div>
      <div class="col">
