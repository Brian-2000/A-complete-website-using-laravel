...
<head>
  <!-- Title -->
  <title>Contact Us - Yielda Capital</title>
  ...
  <section class="footer-section">
    <div class="container">
      ...
      <div class="footer-content">
        <hr>
        <h4>Thank you for your interest in Yielda.</h4>
      </div>
    </div>
  </section>
  ...
  <section class="footer-subsection">
      <div class="container">
          ...
          <h6>
            <div class="row">
              <div class="col card">
                <h6>Email<br><a href="mailto:care@yonova.com">care@yonova.com </a></h6>
              </div>
              <div class="col card">
                <h6>Phone Number<br><a href="tel:+254711555999">+254711555999</a></h6>
              </div>
              <div class="col card">
                <h6>Location<br><a href="mailto:info@example.com">Nairobi, Kenya</a></h6>
              </div>
            </div>
          </h6>
            <h6><b>Careers </b>
            <br>
            Send a resumé to <a href="mailto:info@example.com" >care@yonova.com</a> or find out about employment, recruiting and internships, please go to <a href="{{ url('/about/careers') }}" >Careers Page</a>.
            <h6>
            <hr>
            <h6><b>Client Relations</b> 
            <br>
              Our Client Relations Department can help you resolve issues that are not promptly handled by your Financial Advisor or Branch Manager. For more information, <a href="{{ url('/client-relations') }}" >please click here</a>.
            </h6>
          </div>
      </div>
  </section>
