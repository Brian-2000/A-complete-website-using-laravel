...
<head>
  <!-- Title -->
  <title>Client Relations - Yielda Capital</title>
...
<body>
  ...
  <section class="footer-subsection">
      <div class="container">
          <div class="footer-content" style="margin:2rem">
          <h6>
          Our Client Relations Department can help you resolve any 
          issues that are not promptly resolved by your Financial 
          Advisor or his/her Branch Manager. If you have an issue 
          or concern, we will make it our priority to address it.
          </h6>
          <br>
            <h6>
            At Yielda Wealth Management, your primary contact with our Firm is your 
            Financial Advisor. If concerns arise, you may also feel confident in 
            raising such issues to the Branch Manager. Should you feel the need 
            to escalate your concerns further, you may contact our Client Relations Department by telephone, mail, fax or email. When contacting us, please provide as much detail as possible including account information, dates, names, events, and desired outcome so that we may properly research and address your concerns.
            </h6>
