...
<body>
  ...
  <main id="content" role="main">
    <!-- Hero Section -->
    <div class="gradient-overlay-half-dark-v3 bg-img-hero" style="background-image: url('{{ asset('img/pages-images/449.jpg')}}');">
      <!-- Main Content -->
            ...
            <div class="col-lg-5">
              ...
              <div class="bg-transparent shadow-sm rounded p-6">
                <form class="js-validate">
                  ...
                  <button type="submit" class="btn btn-block btn-default"><a href="{{ url('/started_form/get_started') }}"></a></button>
                </form>
              </div>
              <!-- End Signup Form -->
            </div>
        ...
        <div class="col-md-8" style="background-color: lightblue;">
          ...
          <div class="tab-content" id="v-pills-tabContent">
              ...
              <div class="row">
                <div class="col-sm-6 mb-7 mb-sm-9">
                  ...
                  <div class="pr-lg-4" style="color: white;">
                    <img class="max-width-9 mb-2" src="{{ asset('svg/components/desk-with-mac-primary-icon.svg') }}" alt="Image Description">
                ...
                <div class="col-sm-6 mb-7 mb-sm-9">
                  <!-- Icon Block -->
                  <div class="pr-lg-4">
                    <img class="max-width-9 mb-2" src="{{ asset('svg/components/careers-blue-icon.svg') }}" alt="Image Description">
                    <hr>
                ...
                <div class="col-sm-6 mb-7 mb-sm-0">
                  <!-- Icon Block -->
                  <div class="pr-lg-4">
                    <img class="max-width-9 mb-2" src="{{ asset('svg/components/consult-cyan-icon.svg') }}" alt="Image Description">
                ...
                <div class="col-sm-6">
                  <!-- Icon Block -->
                  <div class="pr-lg-4">
                    <img class="max-width-9 mb-2" src="{{ asset('svg/components/data-analysis-red-icon.svg') }}" alt="Image Description">
                    <hr>
            ...
            <div class="tab-pane fade" id="v-pills-key-benefits" role="tabpanel" aria-labelledby="v-pills-key-benefits-tab">
              <div class="row align-items-lg-center">
                <div class="col-lg-5 mb-7 mb-7 mb-lg-0">
                  <img class="img-fluid" src="{{ asset('img/pages-images/deft2.jpg') }}" alt="Image Description">
                </div>
            ...
            <div class="tab-pane fade" id="v-pills-key-remote" role="tabpanel" aria-labelledby="v-pills-key-remote-tab">
              <div class="row align-items-lg-center">
                <div class="col-lg-5 mb-7 mb-7 mb-lg-0">
                  <img class="img-fluid" src="{{ asset('img/pages-images/remote-work.jpeg') }}" alt="Image Description">
                </div>
            ...
            <div class="tab-pane fade" id="v-pills-key-security" role="tabpanel" aria-labelledby="v-pills-key-security-tab">
              <div class="row align-items-lg-center">
                <div class="col-lg-5 mb-7 mb-7 mb-lg-0">
                  <img class="img-fluid" src="{{ asset('img/pages-images/security-services.jpeg') }}" alt="Image Description">
                </div>
            ...
            <div class="tab-pane fade" id="v-pills-company" role="tabpanel" aria-labelledby="v-pills-company-tab">
              <div class="row">
                <div class="col-sm-6 mb-7 mb-sm-9">
                  <!-- Icon Block -->
                  <div class="pr-lg-4">
                    <img class="max-width-9 mb-2" src="{{ asset('svg/components/real-time-sync-icon.svg') }}" alt="Image Description">
                ...
                <div class="col-sm-6 mb-7 mb-sm-9">
                  <!-- Icon Block -->
                  <div class="pr-lg-4">
                    <img class="max-width-9 mb-2" src="{{ asset('svg/components/services-dark-icon.svg') }}" alt="Image Description">
                ...
                <div class="col-sm-6 mb-7 mb-md-9">
                  <!-- Icon Block -->
                  <div class="pr-lg-4">
                    <img class="max-width-9 mb-2" src="{{ asset('svg/components/team-red-icon.svg') }}" alt="Image Description">
                ...
                <div class="col-sm-6">
                  <!-- Icon Block -->
                  <div class="pr-lg-4">
                    <img class="max-width-9 mb-2" src="{{ asset('svg/components/seo-white-icon.svg') }}" alt="Image Description">
      ...
      <div class="row justify-content-lg-center">
        <div class="col-md-6 col-lg-5 mb-7 mb-md-0">
          ...
          <div class="text-center px-lg-4">
            <div class="mb-2">
              <img class="u-avatar rounded-circle mx-auto mb-2" src="{{ asset('img/pages-images/brian.jpg') }}" alt="Image Description">
        ...
        <div class="col-md-6 col-lg-5">
          ...
          <div class="text-center px-lg-4">
            <div class="mb-2">
              <img class="u-avatar rounded-circle mx-auto mb-4" src="{{ asset('img/pages-images/kevin.jpg') }}" alt="Image Description">
