...
<head>
  <!-- Title -->
  <title>Get Started- Yielda Capital</title>
...
<body>
  ...
  <section class="get-started-form">
    <div class="progressbar-container py-3">
      <div class="progress">
        <div role="progressbar" class="progress-bar" style="width: 10%; background-color: rgb(78, 66, 250);"></div>
      </div>
    </div>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-step="1">
          <div class="content">
            <div class="row">
              <div class="col-6">
                <h3>Plan your optimal investment<br> portfolio</h3>
                <h5 style="color:#212529;">Determine your investor type to get a portfolio recommendation.
                Then fill in your information,<br> transfer the funds and make it real.</h5>
                <button><a href="#myCarousel"role="button" data-slide="next">Get Started</a></button>
              </div>
            </div>
          </div>
        </div>
        <div class="carousel-item" data-step="2">
          <div class="content">
            <div class="row">
              <div class="col-6">
                <h6 style="font-weight:700; font-family:'Poppins',sans-serif; margin-bottom:2rem; letter-spacing: 1px; color:#212529;">YOUR INVESTOR PROFILE</h6>
                <h4 style="font-size:1.75em; font-weight:300;  font-family:'Poppins',sans-serif;color:#222;">It's great meeting you!</h4>
                <h5 style="font-size:1.2em; color:#212529;">We'll ask you a couple of questions to understand where you are in your 
                  financial journey and create an investment plan that works best for you.<br><br>This stays 
                  between us, we won't share your information with anyone.</h5>
                <button><a href="#myCarousel"role="button" data-slide="next">Continue</a></button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item" data-step="4">
          <div class="content">
            <img src="http://placehold.it/1100x300/444?text=4" class='h-100 w-100'>
          </div>
        </div>
        <div class="carousel-item" data-step="5">
          <div class="content">
            <img src="http://placehold.it/1100x300/444?text=5" class='h-100 w-100'>
          </div>
        </div>
        <div class="carousel-item" data-step="6">
          <div class="content">
            <img src="http://placehold.it/1100x300/444?text=6" class='h-100 w-100'>
          </div>
        </div>
        <div class="carousel-item" data-step="7">
          <div class="content">
            <img src="http://placehold.it/1100x300/444?text=7" class='h-100 w-100'>
          </div>
        </div>
        <div class="carousel-item" data-step="8">
          <div class="content">
            <img src="http://placehold.it/1100x300/444?text=8" class='h-100 w-100'>
          </div>
        </div>
        <div class="carousel-item" data-step="9">
          <div class="content">
            <img src="http://placehold.it/1100x300/444?text=9" class='h-100 w-100'>
          </div>
        </div>
        <div class="carousel-item" data-step="10">
          <div class="content">
            <img src="http://placehold.it/1100x300/444?text=10" class='h-100 w-100'>
          </div>
        </div>
      </div>
      <a class="back" href="#myCarousel" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
      </a>
      <span class="progresstext">1/10</span>
      ...
      <div class="u-sidebar__container">
        <div class="u-sidebar--panel__footer-offset">
          ...
          <div class="d-flex align-items-center border-bottom py-4 px-5">
            ...
            <button type="button" class="close u-sidebar__close ml-auto" aria-controls="sidebarContent" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-hide-on-scroll="false" data-unfold-target="#sidebarContent" data-unfold-type="css-animation" data-unfold-animation-in="fadeInRight" data-unfold-animation-out="fadeOutRight" data-unfold-duration="500">
