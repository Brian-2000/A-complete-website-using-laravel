...
<head>
  <!-- Title -->
  <title>Careers - Deft Technologies Limited</title>
  ...
  <section class="wwd-section">
    <div class="container">
      ...
      <div class="wwd-content">
        <hr>
        <h4>At Blackstone, we don’t just think about recruitment; we invest 
        in retention and development. Our objective is to recognize talent, 
        respect hard work and reward success.</h4>
      </div>
    </div>
  </section>
    ...
    <div class="row">
      ...
      <div class="col">
        <div class="wwd-subsection-content">
          <p>Our employees are integral to the firm’s culture of integrity, professionalism and excellence.
          At Yielda, we look to attract and retain the brightest minds in the business, 
          hiring professionals and students in every area of the firm. Our employees’ 
          passion for their work and commitment to their clients have helped Yielda 
          become one of the most respected financial institutions and a trusted partner 
          for some of the largest investors in the world.</p>
              <hr>
              <h5>Our Most Valuable Asset</h5>
              <p>Our people are our most valuable asset. They are highly skilled 
              problem solvers who believe challenges represent opportunities. 
              Together with the firm’s entrepreneurial spirit, their unique 
              passions and backgrounds contribute to a diverse, creative and 
              vibrant environment.</p>
              <hr>
              <h5>Students</h5>
              <p>Yielda seeks to hire the best and brightest students into our 
              Investment and Corporate businesses. Each line of business offers 
              unique opportunities to grow and develop junior talent.</p>
        </div>
      </div>
    </div>
    </div>
  ...
  <section class="wwd-subsection-2">
    <div class="container">
        <div class="wwd-subsection-2-title">
            <h3>The Employer of Choice</h3>
            <h6>We encourage independent thinking and reward initiative, 
            while providing new skills, training and mentoring to help our people 
            grow professionally. Our global business platform and brand reputation
            provide an unparalleled launchpad for your growing career.</h6>
        </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="content">
                        <hr align="left">
                        <h5>Training</h5>
                        <p>Yielda is committed to offering learning and development 
                            opportunities to help advance our employees’ careers across 
                            a number of areas: investing skills, leadership and management, 
                            communication and technology, among others.</p>
                    </div>
                </div>
                <div class="col">
                    <div class="content">
                        ...
                        <p>At Yielda, we actively promote diversity and inclusion inside our firm 
                            and throughout our industry. Our efforts include internal networks to engage 
                            our diverse populations; targeted recruiting efforts to attract qualified, 
                            diverse talent to Yielda; and partnerships with external diversity- and 
                            inclusion-focused organizations.</p>
                    </div>
                </div>
                <div class="col">
                    <div class="content">
                        <hr align="left">
                        <h5>Benefits</h5>
                        <p>Our employee benefits are considered comprehensive and competitive. In addition 
                            to robust health and retirement offerings, we provide our employees with a wide
                            variety of quality of life benefits, including time-off options and perks like 
                            well-being and family planning resources.</p>
                    </div>
                </div>
            </div>
        </div>
