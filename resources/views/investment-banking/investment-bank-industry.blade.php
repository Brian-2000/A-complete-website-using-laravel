...
<head>
  <!-- Title -->
  <title>Business Sites- Deft Technologies Limited</title>
  ...
  <section class="wwd-section">
    <div class="container">
      ...
      <div class="wwd-content">
        <h4>The Future of Business Accounting is here with us.
          At Deft Technologies Limited, we design Websites that fit all businesses.
          The sites that will attract customers to business and wiew their products,
          sites that customers can easily deal with.
        </h4>
      </div>
    </div>
  </section>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="{{ asset('img/pages-images/Business-Website-Accounting-sm.jpg') }}" />
      </div>
      <div class="col">
