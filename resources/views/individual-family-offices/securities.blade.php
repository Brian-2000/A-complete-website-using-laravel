  ...
  <section class="wwd-section">
    <div class="container">
      ...
      <div class="wwd-content">
        <hr>
        <h4>Network Security remains one of the most important issues in the world of Technology.
          at Deft Technologies Limited, we are highly commited to ensuring advanced security to our clients
        </h4>
      </div>
    </div>
  </section>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="{{ asset('img/pages-images/ensuring_network_security.png') }}" />
      </div>
      <div class="col">
        <div class="wwd-subsection-content">
                <p>At Deft Technologies Limited, we value you the most.</p>
                </div>
      </div>
    </div>
    </div>
