...
<head>
  <!-- Title -->
  <title>Portfolio Oversight - Yielda Capital</title>
  ...
  <section class="wwd-section">
    <div class="container">
      ...
      <div class="wwd-content">
        <hr>
        <h4>In all areas of portfolio supervision and management, our committed team of seasoned professionals collaborates closely with key financial institutions.
We have the scope and expertise to perform valuations and disposals in large numbers on behalf of our client, thanks to a nationwide network that reaches all corners of the world. </h4>
      </div>
    </div>
  </section>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="{{ asset('img/pages-images/portfolio-oversight.jpeg') }}" />
      </div>
      <div class="col">
        <div class="wwd-subsection-content">
            <p>Both of our public and private funds are managed by the Portfolio Oversight Team, which oversees their structure, 
              activities, and investment priorities.It oversees and drives portfolio 
              results, fosters partnerships with current and prospective 
              partners and co-investors, contributes to the development 
              of new products, collaborates closely with institutional 
              partners, and shares asset management responsibilities with 
              the Investments Team. </p>
          <hr>
            <p>Monthly servicing data is ingested by our teams in order to detect and review exceptions, escalate them to the servicer's attention, and prescribe action to address them.
Cash application and escrow review, delinquency and cost reconciliation, default servicing timeline management, and more are all examples of this. </p>
