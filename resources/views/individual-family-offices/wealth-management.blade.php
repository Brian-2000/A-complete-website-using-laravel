...
<head>
  <!-- Title -->
  <title>Wealth Management - Yielda Capital</title>
  ...
  <section class="wwd-section">
    <div class="container">
      ...
      <div class="wwd-content">
        <hr>
        <h4>We partner with clients to help them reach their investment goals and financial well-being,
             and we bring a fresh perspective to conventional consumer banking activities. </h4>
      </div>
    </div>
  </section>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="{{ asset('img/pages-images/wealth-management.jpeg') }}" />
      </div>
      <div class="col">
        <div class="wwd-subsection-content">
            <p>We assist our clients in achieving their wealth management objectives by providing careful guidance, 
                astute investment management, and access to Yielda's capabilities and network. </p>
          <hr>
            <p>We create wealth and investment management strategies in collaboration with high-net-worth individuals, 
                families, and select foundations and endowments.
                We then find investment opportunities to assist them in achieving their goals.
                These programmes are supplemented by strong implementation capabilities and responsive client support.
                Where applicable, we link our clients to Yielda's larger network and services. </p>
          <hr>
            <p>Yielda Wealth Management provides insightful advice on a variety of subjects,
                 including asset allocation, investment strategies, market trends, and wealth management.</p>
      </div>
    </div>
    </div>
  </section>
