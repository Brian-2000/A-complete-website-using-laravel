  ...
  <section class="people-section">
      <div class="hero">
          <div class="people-section-title">
              <h4>DECLAIMER.</h4>
              <p>Deft Technologies Limited notes that any correspondences regarding any
                 position that is advertised on behalf of our company shall be communicated 
                 through our official email address and telephone numbers; as follows; 
                 info@defttech.co.ke, +254799737828  respectively.
                  In case of any doubtful communication, our customers are advised
                   to seek clarification from the contact information provided above 
                   before taking any further steps.</p>
          </div>
      </div>
  </section>

  <section class="people-subsection">
      <div class="container">
          <h3>Need Help?</h3>
          <hr>
          <div class="row">
