...
<head>
  <!-- Title -->
  <title>Deft Leadership - Deft Technologies Limited</title>
...
<body>
  ...
  <section class="leadership-section">
    <div class="container">
      <div class="leadership-title-section" style="background-image: url('{{ asset('img/pages-images/downsize_200k_v1.jpg')}}">
        <h4 style="color: forestgreen; background-image: url('{{ asset('img/pages-images/449.jpg')}}">Deft Technologies Limited Leadership</h4>
        <hr>
        <h6 style="color: forestgreen">Deft Technologies Team</h6>
      </div>
    </div>
  </section>

  <section class="leadership-subsection-1">
   <div class="container">
     <div class="row">
       <div class="col-6 ml-auto mr-auto">
          <div class="leadership-card">
              <div class="card-image">
                <img src="{{ asset('img/pages-images/kevin.jpg') }}"/>
              </div>
