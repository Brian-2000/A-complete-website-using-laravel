  ...
  <section class="wwd-section">
    <div class="container">
      <div class="wwd-title">
        ...
        <hr>
        <h4>In computing, virtualization or virtualisation 
          (sometimes abbreviated v12n, a numeronym) is the act of creating 
          a virtual (rather than actual) version of something, 
          including virtual computer hardware platforms, 
          storage devices, and computer network resources.</h4>
      </div>
    </div>
  </section>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="{{ asset('img/pages-images/what_is_virtualization.png') }}" />
      </div>
      <div class="col">
