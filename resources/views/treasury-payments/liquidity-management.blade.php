...
<head>
  <!-- Title -->
  <title>Contegency planning- Deft Technologies Limited</title>
  ...
  <section class="wwd-subsection">
    ...
    <div class="row">
      <div class="col wwd-subsection-title">
          <img src="{{ asset('img/pages-images/business-contingency-plan.png') }}" />
      </div>
      <div class="col ">
        <div class="wwd-subsection-content">
            
            <p>A contingency plan is a plan devised for an
               outcome other than in the usual (expected) plan.
                It is often used for risk management for an exceptional 
                risk that, though unlikely, would have catastrophic consequences.
                 Contingency plans are often devised by governments or businesses </p>
              <hr>
              
              <p>At Deft Technologies Limited, We provide plan A, plan B and even \
                plan C for our clients incase of anything fatal happenning to their businesses
              </p>
